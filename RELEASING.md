...
1. Navigate to the repo in GitHub > [Actions](https://github.com/adobe/brightspeed/actions).
...
1. Download the artifact `brightspeed.all-X.X.X.zip`.
...
3. Go to https://github.com/adobe/brightspeed/releases and edit the release tag and update the release text. Add compiled AEM Packages for AEM as a Cloud Service (default build) and special classic build for 6.x.x.
...
After you release **AEM WKND Sites Project** (aka brightspeed) using any one of the above methods, follow below steps to publish it.

1. Go to https://github.com/adobe/brightspeed/releases and edit the release tag and update the release text. Add compiled AEM Packages from the previous step.
